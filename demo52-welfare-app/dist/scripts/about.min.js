...
$(function () {
    ...
    ({
        ...
        getBannerInfos: function () {
            this.getAjax("/introduction", {}, function (e) {
                console.log(e), 200 == e.status ? ($("#about-body>main .about-us .text").html(e.data.accompany), $("#about-body>main .about-brothers .text").html(e.data.hb), $("#about-body>main .about-cnr .text").html(e.data.cnr)) : alert(e.message)
            })
        },
